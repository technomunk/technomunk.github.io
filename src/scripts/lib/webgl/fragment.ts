    ...
    protected _setUniforms(uniforms: Uniforms) {
        ...
        for (const [name, value] of Object.entries(uniforms)) {
            ...
            if (value instanceof Array) {
                switch (value.length) {
                    case 2: this.context.uniform2f(location, ...value); break
                    case 3: this.context.uniform3f(location, ...value); break
                    case 4: this.context.uniform4f(location, ...value); break
                }
            } else {
