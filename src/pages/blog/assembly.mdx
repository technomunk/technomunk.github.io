---
title: 'Technomunk on: Assembly'
description: '10-minute crash course to demystify assembly languages'
layout: ../../layouts/Blog.astro
fallbackLang: asm
---

import AssemblyInterpreter from "../../components/AssemblyInterpreter.astro";

# Assembly

Assembly is a family of low-level programming languages that generally look like this:
<AssemblyInterpreter arg="16,25,36,59,64">
```asm
; find an integer that is close to the square root of edi
